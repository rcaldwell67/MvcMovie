...
{
    public class Wagers_History
    {
        #region Constructors  
        public Wagers_History() { }
        #endregion
        ...
        [Display(Name = "Wager Date")]
        public DateTime wagerDateTime { get { return _wagerDateTime; } set { _wagerDateTime = value; } }

        public string betslipHash { get { return _betslipHash; } set { _betslipHash = value; } }

        public string wagerHash { get { return _wagerHash; } set { _wagerHash = value; } }

        [Display(Name = "Wager Status")]
        public string wagerStatus { get { return _wagerStatus; } set { _wagerStatus = value; } }
